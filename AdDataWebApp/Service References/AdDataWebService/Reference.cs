...
namespace AdDataWebApp.AdDataWebService {
    ...
    public partial class Ad : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private AdDataWebApp.AdDataWebService.Brand BrandField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AdDataWebApp.AdDataWebService.Brand Brand {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="AdDataWebService.IAdDataService")]
    public interface IAdDataService {
        ...
        AdDataWebApp.AdDataWebService.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdDataService/GetAdDataByDateRange", ReplyAction="http://tempuri.org/IAdDataService/GetAdDataByDateRangeResponse")]
        System.Threading.Tasks.Task<AdDataWebApp.AdDataWebService.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdDataServiceChannel : AdDataWebApp.AdDataWebService.IAdDataService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdDataServiceClient : System.ServiceModel.ClientBase<AdDataWebApp.AdDataWebService.IAdDataService>, AdDataWebApp.AdDataWebService.IAdDataService {
        ...
        public AdDataWebApp.AdDataWebService.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate) {
            return base.Channel.GetAdDataByDateRange(startDate, endDate);
        }
        
        public System.Threading.Tasks.Task<AdDataWebApp.AdDataWebService.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate) {
